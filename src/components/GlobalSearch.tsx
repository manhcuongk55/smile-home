        ...
        <>
            ...
            <div
                ...
                style={{
                    ...
                    padding: '10px 16px', margin: '0 0 20px 0',
                    background: 'var(--bg-card)', border: '1px solid var(--border-subtle)',
                    borderRadius: 'var(--radius-md)', cursor: 'pointer',
                    transition: 'all 200ms ease',
                }}
                onMouseEnter={(e) => { e.currentTarget.style.borderColor = 'rgba(56,189,248,0.3)'; e.currentTarget.style.boxShadow = '0 0 20px rgba(56,189,248,0.08)'; }}
                onMouseLeave={(e) => { e.currentTarget.style.borderColor = 'var(--border-subtle)'; e.currentTarget.style.boxShadow = 'none'; }}
            >
                <span style={{ fontSize: '1rem' }}>🔍</span>
                <span style={{ flex: 1, color: 'var(--text-muted)', fontSize: '0.85rem' }}>Tìm người, phòng, hợp đồng...</span>
                <span style={{ padding: '2px 8px', borderRadius: 5, background: 'var(--bg-secondary)', color: 'var(--text-muted)', fontSize: '0.65rem', fontWeight: 600, border: '1px solid var(--border-subtle)' }}>Ctrl+K</span>
            </div>
